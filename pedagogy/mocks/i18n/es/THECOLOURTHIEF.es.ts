...
// história: THECOLOURTHIEF · idioma: es · modelo: mock · 2026-07-01
...
export const THECOLOURTHIEF: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] When Orange Went Missing",
    "emoji": "🎨",
    "locked": false,
    "creatureCard": {
