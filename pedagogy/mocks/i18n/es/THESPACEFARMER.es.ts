...
// história: THESPACEFARMER · idioma: es · modelo: mock · 2026-07-01
...
export const THESPACEFARMER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] Soil at Zero Gravity",
    "emoji": "🌾",
    "locked": false,
    "scienceFact": {
