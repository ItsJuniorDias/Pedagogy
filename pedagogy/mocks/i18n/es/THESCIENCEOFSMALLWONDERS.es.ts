...
// história: THESCIENCEOFSMALLWONDERS · idioma: es · modelo: mock · 2026-07-01
...
export const THESCIENCEOFSMALLWONDERS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] What Rain Smells Like",
    "emoji": "🌧️",
    "locked": false,
    "scienceFact": {
      "title": "Petrichor",
