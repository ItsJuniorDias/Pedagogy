...
// história: THEGIANTWHOWEPT · idioma: es · modelo: mock · 2026-07-01
...
export const THEGIANTWHOWEPT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] G is for Gulliver the Giant",
    "emoji": "🏔️",
    "locked": false,
    "letterFriend": {
      "letter": "G",
