...
// história: THECHRONONAUTS · idioma: es · modelo: mock · 2026-07-01
...
export const THECHRONONAUTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Archaeology of Now",
    "emoji": "⏳",
    "locked": false,
    "missionBrief": {
