...
// história: THECLOUDREADER · idioma: es · modelo: mock · 2026-07-01
...
export const THECLOUDREADER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] Partly Cloudy With a Chance of Everything",
    "emoji": "⛅",
    "locked": false,
    "weatherReport": {
