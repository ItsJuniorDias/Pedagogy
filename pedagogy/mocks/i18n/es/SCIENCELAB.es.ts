...
// história: SCIENCELAB · idioma: es · modelo: mock · 2026-07-01
...
export const SCIENCELAB: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Lesson 1",
    "subtitle": "[es] Thinking Like a Scientist",
    "emoji": "🔬",
    "locked": false,
    "labNotebook": {
