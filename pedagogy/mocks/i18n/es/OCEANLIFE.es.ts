...
// história: OCEANLIFE · idioma: es · modelo: mock · 2026-07-01
...
export const OCEANLIFE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Lesson 1",
    "subtitle": "[es] Welcome to the Ocean",
    "emoji": "🌊",
    "locked": false,
    "deepDiveCard": {
