...
// história: THEDREAMARCHITECT · idioma: es · modelo: mock · 2026-07-01
...
export const THEDREAMARCHITECT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Blueprint in the Dark",
    "emoji": "💭",
    "locked": false,
    "runeSymbol": {
      "symbol": "⌖",
