...
// história: THEFORGOTTENALPHABET · idioma: es · modelo: mock · 2026-07-01
...
export const THEFORGOTTENALPHABET: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Letters That Were Left Behind",
    "emoji": "🔤",
    "locked": false,
    "letterFriend": {
      "letter": "Ƿ",
