...
// história: ASTRONAUT · idioma: es · modelo: mock · 2026-07-01
...
export const ASTRONAUT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Lesson 1",
    "subtitle": "[es] What Is Space, Exactly?",
    "emoji": "🌌",
    "locked": false,
    "factFile": {
      "topic": "The Universe",
