...
// história: THESPELLCHECKER · idioma: es · modelo: mock · 2026-07-01
...
export const THESPELLCHECKER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Red Pen That Wasn't",
    "emoji": "✏️",
    "locked": false,
    "dictionaryEntry": {
      "word": "Orthomancy",
