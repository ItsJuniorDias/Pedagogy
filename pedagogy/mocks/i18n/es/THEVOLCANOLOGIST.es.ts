...
// história: THEVOLCANOLOGIST · idioma: es · modelo: mock · 2026-07-01
...
export const THEVOLCANOLOGIST: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Mountain That Breathes",
    "emoji": "🌋",
    "locked": false,
    "scienceFact": {
