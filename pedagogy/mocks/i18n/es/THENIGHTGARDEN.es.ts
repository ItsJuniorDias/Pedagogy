...
// história: THENIGHTGARDEN · idioma: es · modelo: mock · 2026-07-01
...
export const THENIGHTGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] After Bedtime, Before Sleep",
    "emoji": "🌙",
    "locked": false,
    "feelingCard": {
      "emoji": "😴",
