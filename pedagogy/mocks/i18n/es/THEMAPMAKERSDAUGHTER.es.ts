...
// história: THEMAPMAKERSDAUGHTER · idioma: es · modelo: mock · 2026-07-01
...
export const THEMAPMAKERSDAUGHTER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Map That Erased Itself",
    "emoji": "🗺️",
    "locked": false,
    "rune": {
      "symbol": "◈",
