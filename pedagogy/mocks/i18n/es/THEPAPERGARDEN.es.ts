...
// história: THEPAPERGARDEN · idioma: es · modelo: mock · 2026-07-01
...
export const THEPAPERGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] What You Can Make From a Square",
    "emoji": "🌸",
    "locked": false,
    "recipe": {
