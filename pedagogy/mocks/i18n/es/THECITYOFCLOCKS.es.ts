...
// história: THECITYOFCLOCKS · idioma: es · modelo: mock · 2026-07-01
...
export const THECITYOFCLOCKS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] Where Every Second Is Counted",
    "emoji": "🕰️",
    "locked": false,
    "missionBrief": {
