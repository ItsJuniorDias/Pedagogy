...
// história: THEGRANDMOTHERSRECIPEBOX · idioma: es · modelo: mock · 2026-07-01
...
export const THEGRANDMOTHERSRECIPEBOX: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Soup for Homesickness",
    "emoji": "🍲",
    "locked": false,
    "recipe": {
