...
// história: THEVOWELVILLAGE · idioma: es · modelo: mock · 2026-07-01
...
export const THEVOWELVILLAGE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] A is for Ava the Astronomer",
    "emoji": "🔭",
    "locked": false,
    "letterFriend": {
      "letter": "A",
