...
// história: THEINSECTORCHESTRA · idioma: es · modelo: mock · 2026-07-01
...
export const THEINSECTORCHESTRA: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] First Movement: The Cricket Section",
    "emoji": "🦗",
    "locked": false,
    "verse": {
      "lines": [
