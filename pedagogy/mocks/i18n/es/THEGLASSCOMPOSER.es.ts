...
// história: THEGLASSCOMPOSER · idioma: es · modelo: mock · 2026-07-01
...
export const THEGLASSCOMPOSER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] Music in the Broken Things",
    "emoji": "🎼",
    "locked": false,
    "poem": {
