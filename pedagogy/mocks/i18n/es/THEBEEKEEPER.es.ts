...
// história: THEBEEKEEPER · idioma: es · modelo: mock · 2026-07-01
...
export const THEBEEKEEPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[es] Chapter 1",
    "subtitle": "[es] The Hive in the Lemon Tree",
    "emoji": "🐝",
    "locked": false,
    "recipe": {
