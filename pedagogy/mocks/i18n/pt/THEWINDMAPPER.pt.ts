...
// história: THEWINDMAPPER · idioma: pt · modelo: mock · 2026-07-01
...
export const THEWINDMAPPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] The Invisible Rivers",
    "emoji": "💨",
    "locked": false,
    "weatherReport": {
      "date": "Any windy day",
