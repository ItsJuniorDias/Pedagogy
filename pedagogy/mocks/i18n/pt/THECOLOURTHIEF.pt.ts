...
// história: THECOLOURTHIEF · idioma: pt · modelo: mock · 2026-07-01
...
export const THECOLOURTHIEF: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] When Orange Went Missing",
    "emoji": "🎨",
    "locked": false,
    "creatureCard": {
