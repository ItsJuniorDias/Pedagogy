...
// história: THECLOCKWORKDETECTIVE · idioma: pt · modelo: mock · 2026-07-01
...
export const THECLOCKWORKDETECTIVE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] The Case of the Stolen Afternoon",
    "emoji": "🔍",
    "locked": false,
    "riddle": {
