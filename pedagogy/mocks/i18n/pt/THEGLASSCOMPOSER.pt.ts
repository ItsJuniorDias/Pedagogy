...
// história: THEGLASSCOMPOSER · idioma: pt · modelo: mock · 2026-07-01
...
export const THEGLASSCOMPOSER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] Music in the Broken Things",
    "emoji": "🎼",
    "locked": false,
    "poem": {
