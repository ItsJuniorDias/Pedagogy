...
// história: THEVOWELVILLAGE · idioma: pt · modelo: mock · 2026-07-01
...
export const THEVOWELVILLAGE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] A is for Ava the Astronomer",
    "emoji": "🔭",
    "locked": false,
    "letterFriend": {
      "letter": "A",
