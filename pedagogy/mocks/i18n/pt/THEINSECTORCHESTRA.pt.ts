...
// história: THEINSECTORCHESTRA · idioma: pt · modelo: mock · 2026-07-01
...
export const THEINSECTORCHESTRA: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] First Movement: The Cricket Section",
    "emoji": "🦗",
    "locked": false,
    "verse": {
      "lines": [
