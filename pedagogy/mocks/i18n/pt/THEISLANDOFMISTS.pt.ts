...
// história: THEISLANDOFMISTS · idioma: pt · modelo: mock · 2026-07-01
...
export const THEISLANDOFMISTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] The Map That Changed",
    "emoji": "🏝️",
    "locked": false,
    "riddle": {
