...
// história: THEBEEKEEPER · idioma: pt · modelo: mock · 2026-07-01
...
export const THEBEEKEEPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] The Hive in the Lemon Tree",
    "emoji": "🐝",
    "locked": false,
    "recipe": {
