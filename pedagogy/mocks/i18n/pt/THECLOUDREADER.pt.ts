...
// história: THECLOUDREADER · idioma: pt · modelo: mock · 2026-07-01
...
export const THECLOUDREADER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] Partly Cloudy With a Chance of Everything",
    "emoji": "⛅",
    "locked": false,
    "weatherReport": {
