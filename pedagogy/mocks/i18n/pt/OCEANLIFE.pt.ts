...
// história: OCEANLIFE · idioma: pt · modelo: mock · 2026-07-01
...
export const OCEANLIFE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Lesson 1",
    "subtitle": "[pt] Welcome to the Ocean",
    "emoji": "🌊",
    "locked": false,
    "deepDiveCard": {
