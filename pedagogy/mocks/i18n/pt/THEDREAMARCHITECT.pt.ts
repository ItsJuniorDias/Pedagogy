...
// história: THEDREAMARCHITECT · idioma: pt · modelo: mock · 2026-07-01
...
export const THEDREAMARCHITECT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] The Blueprint in the Dark",
    "emoji": "💭",
    "locked": false,
    "runeSymbol": {
      "symbol": "⌖",
