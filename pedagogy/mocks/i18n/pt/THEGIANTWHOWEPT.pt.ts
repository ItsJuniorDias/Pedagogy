...
// história: THEGIANTWHOWEPT · idioma: pt · modelo: mock · 2026-07-01
...
export const THEGIANTWHOWEPT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] G is for Gulliver the Giant",
    "emoji": "🏔️",
    "locked": false,
    "letterFriend": {
      "letter": "G",
