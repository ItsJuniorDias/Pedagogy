...
// história: THESCIENCEOFSMALLWONDERS · idioma: pt · modelo: mock · 2026-07-01
...
export const THESCIENCEOFSMALLWONDERS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] What Rain Smells Like",
    "emoji": "🌧️",
    "locked": false,
    "scienceFact": {
      "title": "Petrichor",
