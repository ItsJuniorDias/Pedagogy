...
// história: THEMAPMAKERSDAUGHTER · idioma: pt · modelo: mock · 2026-07-01
...
export const THEMAPMAKERSDAUGHTER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] The Map That Erased Itself",
    "emoji": "🗺️",
    "locked": false,
    "rune": {
      "symbol": "◈",
