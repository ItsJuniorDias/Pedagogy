...
// história: THENIGHTGARDEN · idioma: pt · modelo: mock · 2026-07-01
...
export const THENIGHTGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] After Bedtime, Before Sleep",
    "emoji": "🌙",
    "locked": false,
    "feelingCard": {
      "emoji": "😴",
