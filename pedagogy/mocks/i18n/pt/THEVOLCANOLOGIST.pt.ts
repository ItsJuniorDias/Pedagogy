...
// história: THEVOLCANOLOGIST · idioma: pt · modelo: mock · 2026-07-01
...
export const THEVOLCANOLOGIST: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] The Mountain That Breathes",
    "emoji": "🌋",
    "locked": false,
    "scienceFact": {
