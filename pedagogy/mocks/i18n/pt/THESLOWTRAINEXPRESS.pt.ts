...
// história: THESLOWTRAINEXPRESS · idioma: pt · modelo: mock · 2026-07-01
...
export const THESLOWTRAINEXPRESS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[pt] Chapter 1",
    "subtitle": "[pt] Departing at No Particular Hour",
    "emoji": "🚂",
    "locked": false,
    "weatherReport": {
