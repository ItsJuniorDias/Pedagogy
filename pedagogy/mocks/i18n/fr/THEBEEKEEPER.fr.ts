...
// história: THEBEEKEEPER · idioma: fr · modelo: mock · 2026-07-01
...
export const THEBEEKEEPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Hive in the Lemon Tree",
    "emoji": "🐝",
    "locked": false,
    "recipe": {
