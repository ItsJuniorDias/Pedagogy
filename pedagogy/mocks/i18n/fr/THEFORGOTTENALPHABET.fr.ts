...
// história: THEFORGOTTENALPHABET · idioma: fr · modelo: mock · 2026-07-01
...
export const THEFORGOTTENALPHABET: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Letters That Were Left Behind",
    "emoji": "🔤",
    "locked": false,
    "letterFriend": {
      "letter": "Ƿ",
