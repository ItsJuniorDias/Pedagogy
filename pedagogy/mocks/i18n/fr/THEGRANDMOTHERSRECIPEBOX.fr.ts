...
// história: THEGRANDMOTHERSRECIPEBOX · idioma: fr · modelo: mock · 2026-07-01
...
export const THEGRANDMOTHERSRECIPEBOX: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Soup for Homesickness",
    "emoji": "🍲",
    "locked": false,
    "recipe": {
