...
// história: SCIENCELAB · idioma: fr · modelo: mock · 2026-07-01
...
export const SCIENCELAB: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Lesson 1",
    "subtitle": "[fr] Thinking Like a Scientist",
    "emoji": "🔬",
    "locked": false,
    "labNotebook": {
      "experiment": "The Mystery Ice Cube",
      "hypothesis": "Which will melt faster: an ice cube wrapped in a wool sock or a bare ice cube?",
      "materials": [
