...
// história: THECLOUDREADER · idioma: fr · modelo: mock · 2026-07-01
...
export const THECLOUDREADER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] Partly Cloudy With a Chance of Everything",
    "emoji": "⛅",
    "locked": false,
    "weatherReport": {
