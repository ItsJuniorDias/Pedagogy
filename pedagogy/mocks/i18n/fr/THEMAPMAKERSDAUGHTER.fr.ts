...
// história: THEMAPMAKERSDAUGHTER · idioma: fr · modelo: mock · 2026-07-01
...
export const THEMAPMAKERSDAUGHTER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Map That Erased Itself",
    "emoji": "🗺️",
    "locked": false,
    "rune": {
      "symbol": "◈",
