...
// história: THESLOWTRAINEXPRESS · idioma: fr · modelo: mock · 2026-07-01
...
export const THESLOWTRAINEXPRESS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] Departing at No Particular Hour",
    "emoji": "🚂",
    "locked": false,
    "weatherReport": {
