...
// história: THEINSECTORCHESTRA · idioma: fr · modelo: mock · 2026-07-01
...
export const THEINSECTORCHESTRA: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] First Movement: The Cricket Section",
    "emoji": "🦗",
    "locked": false,
    "verse": {
      "lines": [
