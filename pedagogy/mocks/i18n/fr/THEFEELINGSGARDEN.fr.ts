...
// história: THEFEELINGSGARDEN · idioma: fr · modelo: mock · 2026-07-01
...
export const THEFEELINGSGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Day Everything Felt Too Big",
    "emoji": "🌱",
    "locked": false,
    "feelingCard": {
      "emoji": "😶",
