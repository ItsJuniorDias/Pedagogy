...
// história: THEPAPERGARDEN · idioma: fr · modelo: mock · 2026-07-01
...
export const THEPAPERGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] What You Can Make From a Square",
    "emoji": "🌸",
    "locked": false,
    "recipe": {
      ...
      "method": "1. Fold in half diagonally both ways, unfold. 2. Fold all four corners to the centre point. 3. Flip over, fold corners to centre again. 4. Flip back over, fold the small squares in the centre outward. 5. Reach underneath and gently pull up the layers to form petals.",
  ...
  },
  {
    ...
    "recipe": {
      ...
      "method": "Each wing is a separate piece. Valley-fold the diagonal, then accordion-fold the resulting triangle into segments. Make both wings identically. Join at the centre with the paper clip — the mechanism allows the wings to flex. Gently curve the wings upward.",
  ...
  },
  {
    ...
    "recipe": {
      ...
      "method": "Fold the square into eighths (fold in half, then in half again, then diagonally). Cut small triangles, curves, or notches from the folded edges — the more varied the cuts, the more intricate the snowflake. Unfold carefully. No two are the same. No two real snowflakes are the same either.",
