...
// história: THEDREAMARCHITECT · idioma: fr · modelo: mock · 2026-07-01
...
export const THEDREAMARCHITECT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Blueprint in the Dark",
    "emoji": "💭",
    "locked": false,
    "runeSymbol": {
      "symbol": "⌖",
      "name": "The Anchor Point",
      "meaning": "The fixed point from which a dream is built. All dream architecture begins here — the single detail that is more real than everything else: a smell, a sound, a texture of light.",
      "instruction": "When you enter a new dream-space, find the Anchor Point first. It tells you whether you built this place or only wandered into it."
    },
    "pages": [
