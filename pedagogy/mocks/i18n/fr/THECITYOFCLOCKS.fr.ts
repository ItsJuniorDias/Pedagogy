...
// história: THECITYOFCLOCKS · idioma: fr · modelo: mock · 2026-07-01
...
export const THECITYOFCLOCKS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] Where Every Second Is Counted",
    "emoji": "🕰️",
    "locked": false,
    "missionBrief": {
