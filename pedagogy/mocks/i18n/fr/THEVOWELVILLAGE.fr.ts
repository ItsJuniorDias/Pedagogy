...
// história: THEVOWELVILLAGE · idioma: fr · modelo: mock · 2026-07-01
...
export const THEVOWELVILLAGE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] A is for Ava the Astronomer",
    "emoji": "🔭",
    "locked": false,
    "letterFriend": {
      "letter": "A",
