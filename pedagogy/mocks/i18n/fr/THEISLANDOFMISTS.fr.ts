...
// história: THEISLANDOFMISTS · idioma: fr · modelo: mock · 2026-07-01
...
export const THEISLANDOFMISTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Map That Changed",
    "emoji": "🏝️",
    "locked": false,
    "riddle": {
