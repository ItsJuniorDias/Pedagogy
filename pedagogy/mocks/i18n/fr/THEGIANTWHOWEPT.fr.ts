...
// história: THEGIANTWHOWEPT · idioma: fr · modelo: mock · 2026-07-01
...
export const THEGIANTWHOWEPT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] G is for Gulliver the Giant",
    "emoji": "🏔️",
    "locked": false,
    "letterFriend": {
      "letter": "G",
