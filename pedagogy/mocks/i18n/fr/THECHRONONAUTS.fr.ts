...
// história: THECHRONONAUTS · idioma: fr · modelo: mock · 2026-07-01
...
export const THECHRONONAUTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Archaeology of Now",
    "emoji": "⏳",
    "locked": false,
    "missionBrief": {
