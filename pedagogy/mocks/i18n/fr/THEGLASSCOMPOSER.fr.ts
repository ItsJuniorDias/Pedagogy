...
// história: THEGLASSCOMPOSER · idioma: fr · modelo: mock · 2026-07-01
...
export const THEGLASSCOMPOSER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] Music in the Broken Things",
    "emoji": "🎼",
    "locked": false,
    "poem": {
