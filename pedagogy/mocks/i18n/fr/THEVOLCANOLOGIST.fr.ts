...
// história: THEVOLCANOLOGIST · idioma: fr · modelo: mock · 2026-07-01
...
export const THEVOLCANOLOGIST: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] The Mountain That Breathes",
    "emoji": "🌋",
    "locked": false,
    "scienceFact": {
