...
// história: THESCIENCEOFSMALLWONDERS · idioma: fr · modelo: mock · 2026-07-01
...
export const THESCIENCEOFSMALLWONDERS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[fr] Chapter 1",
    "subtitle": "[fr] What Rain Smells Like",
    "emoji": "🌧️",
    "locked": false,
    "scienceFact": {
      "title": "Petrichor",
