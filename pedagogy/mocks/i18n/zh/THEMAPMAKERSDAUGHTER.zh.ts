...
// história: THEMAPMAKERSDAUGHTER · idioma: zh · modelo: mock · 2026-07-01
...
export const THEMAPMAKERSDAUGHTER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Map That Erased Itself",
    "emoji": "🗺️",
    "locked": false,
    "rune": {
      "symbol": "◈",
