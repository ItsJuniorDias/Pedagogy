...
// história: THEVOWELVILLAGE · idioma: zh · modelo: mock · 2026-07-01
...
export const THEVOWELVILLAGE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] A is for Ava the Astronomer",
    "emoji": "🔭",
    "locked": false,
    "letterFriend": {
      "letter": "A",
