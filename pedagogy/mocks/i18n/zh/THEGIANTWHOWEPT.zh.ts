...
// história: THEGIANTWHOWEPT · idioma: zh · modelo: mock · 2026-07-01
...
export const THEGIANTWHOWEPT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] G is for Gulliver the Giant",
    "emoji": "🏔️",
    "locked": false,
    "letterFriend": {
      "letter": "G",
