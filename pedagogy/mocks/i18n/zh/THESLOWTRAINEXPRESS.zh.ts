...
// história: THESLOWTRAINEXPRESS · idioma: zh · modelo: mock · 2026-07-01
...
export const THESLOWTRAINEXPRESS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] Departing at No Particular Hour",
    "emoji": "🚂",
    "locked": false,
    "weatherReport": {
