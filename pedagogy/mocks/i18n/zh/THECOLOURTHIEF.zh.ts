...
// história: THECOLOURTHIEF · idioma: zh · modelo: mock · 2026-07-01
...
export const THECOLOURTHIEF: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] When Orange Went Missing",
    "emoji": "🎨",
    "locked": false,
    "creatureCard": {
