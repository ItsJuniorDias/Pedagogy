...
// história: THEFORGOTTENALPHABET · idioma: zh · modelo: mock · 2026-07-01
...
export const THEFORGOTTENALPHABET: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Letters That Were Left Behind",
    "emoji": "🔤",
    "locked": false,
    "letterFriend": {
      "letter": "Ƿ",
