...
// história: SPACE · idioma: zh · modelo: mock · 2026-07-01
...
export const SPACE: LocalizedChapter[] = [
  ...
  },
  {
    ...
    "pages": [
      "[zh] Stars are massive balls of hot gas that emit light and heat. They come in different sizes, colors, and temperatures — from small, cool red dwarfs to massive, hot blue giants. Stars are born in clouds of gas and dust called nebulae, and they go through a life cycle that can last millions or even billions of years. When a star runs out of fuel, it can explode in a supernova, leaving behind a dense core called a neutron star or black hole.",
      "[zh] Galaxies are vast collections of stars, gas, dust, and dark matter held together by gravity. Our galaxy, the Milky Way, contains over 100 billion stars and is just one of billions of galaxies in the universe. Galaxies come in different shapes and sizes — from spiral galaxies like our own to elliptical and irregular galaxies. They can also collide and merge with each other, creating new stars and changing their structure.",
      "[zh] The night sky is filled with stars and galaxies, and each one has its own story to tell. By studying them, we can learn about the history of the universe, the formation of planets, and even the possibility of life beyond Earth. So next time you look up at the stars, remember that you're seeing just a tiny part of a vast and wondrous cosmos!"
    ]
  },
  {
    "id": 3,
    "title": "[zh] Lesson 3",
    "subtitle": "[zh] Black Holes and Neutron Stars",
    "emoji": "🕳️",
    "locked": true,
    "activityCard": {
