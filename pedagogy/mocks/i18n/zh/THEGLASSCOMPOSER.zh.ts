...
// história: THEGLASSCOMPOSER · idioma: zh · modelo: mock · 2026-07-01
...
export const THEGLASSCOMPOSER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] Music in the Broken Things",
    "emoji": "🎼",
    "locked": false,
    "poem": {
