...
// história: ASTRONAUT · idioma: zh · modelo: mock · 2026-07-01
...
export const ASTRONAUT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Lesson 1",
    "subtitle": "[zh] What Is Space, Exactly?",
    "emoji": "🌌",
    "locked": false,
    "factFile": {
      "topic": "The Universe",
