...
// história: THEISLANDOFMISTS · idioma: zh · modelo: mock · 2026-07-01
...
export const THEISLANDOFMISTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Map That Changed",
    "emoji": "🏝️",
    "locked": false,
    "riddle": {
