...
// história: THEVOLCANOLOGIST · idioma: zh · modelo: mock · 2026-07-01
...
export const THEVOLCANOLOGIST: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Mountain That Breathes",
    "emoji": "🌋",
    "locked": false,
    "scienceFact": {
