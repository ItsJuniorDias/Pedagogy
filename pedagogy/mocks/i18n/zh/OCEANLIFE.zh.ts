...
// história: OCEANLIFE · idioma: zh · modelo: mock · 2026-07-01
...
export const OCEANLIFE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Lesson 1",
    "subtitle": "[zh] Welcome to the Ocean",
    "emoji": "🌊",
    "locked": false,
    "deepDiveCard": {
