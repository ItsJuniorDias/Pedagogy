...
// história: THEBEEKEEPER · idioma: zh · modelo: mock · 2026-07-01
...
export const THEBEEKEEPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Hive in the Lemon Tree",
    "emoji": "🐝",
    "locked": false,
    "recipe": {
