...
// história: THEFEELINGSGARDEN · idioma: zh · modelo: mock · 2026-07-01
...
export const THEFEELINGSGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Day Everything Felt Too Big",
    "emoji": "🌱",
    "locked": false,
    "feelingCard": {
      "emoji": "😶",
