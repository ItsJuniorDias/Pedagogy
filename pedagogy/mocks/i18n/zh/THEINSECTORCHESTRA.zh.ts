...
// história: THEINSECTORCHESTRA · idioma: zh · modelo: mock · 2026-07-01
...
export const THEINSECTORCHESTRA: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] First Movement: The Cricket Section",
    "emoji": "🦗",
    "locked": false,
    "verse": {
      "lines": [
