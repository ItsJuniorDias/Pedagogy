...
// história: THEPAPERGARDEN · idioma: zh · modelo: mock · 2026-07-01
...
export const THEPAPERGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] What You Can Make From a Square",
    "emoji": "🌸",
    "locked": false,
    "recipe": {
