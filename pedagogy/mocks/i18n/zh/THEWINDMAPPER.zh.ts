...
// história: THEWINDMAPPER · idioma: zh · modelo: mock · 2026-07-01
...
export const THEWINDMAPPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Invisible Rivers",
    "emoji": "💨",
    "locked": false,
    "weatherReport": {
      "date": "Any windy day",
