...
// história: THENIGHTGARDEN · idioma: zh · modelo: mock · 2026-07-01
...
export const THENIGHTGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] After Bedtime, Before Sleep",
    "emoji": "🌙",
    "locked": false,
    "feelingCard": {
      "emoji": "😴",
