...
// história: THECLOCKWORKDETECTIVE · idioma: zh · modelo: mock · 2026-07-01
...
export const THECLOCKWORKDETECTIVE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Case of the Stolen Afternoon",
    "emoji": "🔍",
    "locked": false,
    "riddle": {
