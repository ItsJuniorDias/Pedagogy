...
// história: THECITYOFCLOCKS · idioma: zh · modelo: mock · 2026-07-01
...
export const THECITYOFCLOCKS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] Where Every Second Is Counted",
    "emoji": "🕰️",
    "locked": false,
    "missionBrief": {
      "missionTitle": "Operation: Tick Tock",
      "objective": "Discover why the Great Central Clock has stopped — without being caught by the Timekeepers.",
      "tools": [
