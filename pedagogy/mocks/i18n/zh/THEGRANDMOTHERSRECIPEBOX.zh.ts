...
// história: THEGRANDMOTHERSRECIPEBOX · idioma: zh · modelo: mock · 2026-07-01
...
export const THEGRANDMOTHERSRECIPEBOX: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[zh] Chapter 1",
    "subtitle": "[zh] The Soup for Homesickness",
    "emoji": "🍲",
    "locked": false,
    "recipe": {
