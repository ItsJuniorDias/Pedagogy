...
// história: THEVOWELVILLAGE · idioma: ar · modelo: mock · 2026-07-01
...
export const THEVOWELVILLAGE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] A is for Ava the Astronomer",
    "emoji": "🔭",
    "locked": false,
    "letterFriend": {
      "letter": "A",
