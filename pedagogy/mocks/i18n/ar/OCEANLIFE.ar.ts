...
// história: OCEANLIFE · idioma: ar · modelo: mock · 2026-07-01
...
export const OCEANLIFE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Lesson 1",
    "subtitle": "[ar] Welcome to the Ocean",
    "emoji": "🌊",
    "locked": false,
    "deepDiveCard": {
