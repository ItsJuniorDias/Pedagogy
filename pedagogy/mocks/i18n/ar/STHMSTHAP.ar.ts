...
// história: STHMSTHAP · idioma: ar · modelo: mock · 2026-07-01
...
export const STHMSTHAP: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Bottle at the Edge of the World",
    "emoji": "🌊",
    "locked": false,
    "riddle": {
  ...
  },
  {
    ...
    "pages": [
      "[ar] The Starmap led Nova to a hidden harbor she had walked past a hundred times without ever seeing. Tucked between two jagged cliffs was a ship unlike any other — its sails were made of parchment covered in tiny handwriting, and its hull glowed faintly gold, like a lantern seen from far away.",
      "[ar] — She only moves if you feed her a story — said a voice.\n\nNova spun around. Sitting on a coil of rope was a boy about her age, with oil-stained hands and mismatched boots. He had the calm expression of someone who had already seen most things twice.\n\n— I'm Cael — he said. — I've been waiting for whoever the Starmap sent.",
      "[ar] Nova eyed him carefully. \"Trust no one else,\" the letter had said. But the Starmap needle was perfectly still now — calm, certain.\n\nShe cleared her throat and began:\n\n— Once, there was a girl who found a bottle at the edge of the world...\n\nThe ship groaned. The sails rustled. And slowly, magnificently, it began to move."
    ]
  },
  {
    "id": 3,
    "title": "[ar] Chapter 3",
    "subtitle": "[ar] The Island That Breathes",
    "emoji": "🏝️",
    "locked": true,
    "riddle": {
