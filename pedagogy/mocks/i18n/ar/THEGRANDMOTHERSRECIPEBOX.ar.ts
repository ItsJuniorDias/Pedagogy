...
// história: THEGRANDMOTHERSRECIPEBOX · idioma: ar · modelo: mock · 2026-07-01
...
export const THEGRANDMOTHERSRECIPEBOX: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Soup for Homesickness",
    "emoji": "🍲",
    "locked": false,
    "recipe": {
