...
// história: THENIGHTGARDEN · idioma: ar · modelo: mock · 2026-07-01
...
export const THENIGHTGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] After Bedtime, Before Sleep",
    "emoji": "🌙",
    "locked": false,
    "feelingCard": {
      "emoji": "😴",
