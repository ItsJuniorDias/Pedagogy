...
// história: THECITYOFCLOCKS · idioma: ar · modelo: mock · 2026-07-01
...
export const THECITYOFCLOCKS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] Where Every Second Is Counted",
    "emoji": "🕰️",
    "locked": false,
    "missionBrief": {
