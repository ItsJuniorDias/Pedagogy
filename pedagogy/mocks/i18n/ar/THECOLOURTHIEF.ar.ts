...
// história: THECOLOURTHIEF · idioma: ar · modelo: mock · 2026-07-01
...
export const THECOLOURTHIEF: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] When Orange Went Missing",
    "emoji": "🎨",
    "locked": false,
    "creatureCard": {
