...
// história: THECHRONONAUTS · idioma: ar · modelo: mock · 2026-07-01
...
export const THECHRONONAUTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Archaeology of Now",
    "emoji": "⏳",
    "locked": false,
    "missionBrief": {
      "missionTitle": "Operation: Present Day",
      "objective": "Locate and document evidence of the past hiding in the present — minimum 10 temporal artefacts within a 500-metre radius.",
      "tools": [
