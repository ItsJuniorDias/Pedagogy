...
// história: SCHOOL · idioma: ar · modelo: mock · 2026-07-01
...
export const SCHOOL: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Lesson 1",
    "subtitle": "[ar] The Morning of Everything",
    "emoji": "🌤️",
    "locked": false,
    "feelingCard": {
      "emoji": "😬",
