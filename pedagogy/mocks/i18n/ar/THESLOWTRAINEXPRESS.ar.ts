...
// história: THESLOWTRAINEXPRESS · idioma: ar · modelo: mock · 2026-07-01
...
export const THESLOWTRAINEXPRESS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] Departing at No Particular Hour",
    "emoji": "🚂",
    "locked": false,
    "weatherReport": {
