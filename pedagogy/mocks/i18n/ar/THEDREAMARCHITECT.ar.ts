...
// história: THEDREAMARCHITECT · idioma: ar · modelo: mock · 2026-07-01
...
export const THEDREAMARCHITECT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Blueprint in the Dark",
    "emoji": "💭",
    "locked": false,
    "runeSymbol": {
      "symbol": "⌖",
