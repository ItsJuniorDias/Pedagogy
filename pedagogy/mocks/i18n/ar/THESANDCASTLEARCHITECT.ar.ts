...
// história: THESANDCASTLEARCHITECT · idioma: ar · modelo: mock · 2026-07-01
...
export const THESANDCASTLEARCHITECT: LocalizedChapter[] = [
  ...
  },
  {
    ...
    "missionBrief": {
      ...
      "tools": [
        "Both builders",
        "The moat system (to be designed)",
        "Urgency"
      ],
      "difficulty": "Advanced",
