...
// história: THESCIENCEOFSMALLWONDERS · idioma: ar · modelo: mock · 2026-07-01
...
export const THESCIENCEOFSMALLWONDERS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] What Rain Smells Like",
    "emoji": "🌧️",
    "locked": false,
    "scienceFact": {
      "title": "Petrichor",
