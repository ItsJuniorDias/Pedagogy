...
// história: THEWINDMAPPER · idioma: ar · modelo: mock · 2026-07-01
...
export const THEWINDMAPPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Invisible Rivers",
    "emoji": "💨",
    "locked": false,
    "weatherReport": {
      "date": "Any windy day",
