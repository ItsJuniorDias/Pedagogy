...
// história: THEFORGOTTENALPHABET · idioma: ar · modelo: mock · 2026-07-01
...
export const THEFORGOTTENALPHABET: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Letters That Were Left Behind",
    "emoji": "🔤",
    "locked": false,
    "letterFriend": {
      "letter": "Ƿ",
