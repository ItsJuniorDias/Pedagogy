...
// história: THECLOCKWORKDETECTIVE · idioma: ar · modelo: mock · 2026-07-01
...
export const THECLOCKWORKDETECTIVE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Case of the Stolen Afternoon",
    "emoji": "🔍",
    "locked": false,
    "riddle": {
