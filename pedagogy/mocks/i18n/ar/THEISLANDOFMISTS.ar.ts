...
// história: THEISLANDOFMISTS · idioma: ar · modelo: mock · 2026-07-01
...
export const THEISLANDOFMISTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Map That Changed",
    "emoji": "🏝️",
    "locked": false,
    "riddle": {
