...
// história: THEFEELINGSGARDEN · idioma: ar · modelo: mock · 2026-07-01
...
export const THEFEELINGSGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[ar] Chapter 1",
    "subtitle": "[ar] The Day Everything Felt Too Big",
    "emoji": "🌱",
    "locked": false,
    "feelingCard": {
      "emoji": "😶",
