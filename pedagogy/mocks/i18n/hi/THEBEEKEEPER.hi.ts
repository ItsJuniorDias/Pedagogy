...
// história: THEBEEKEEPER · idioma: hi · modelo: mock · 2026-07-01
...
export const THEBEEKEEPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Hive in the Lemon Tree",
    "emoji": "🐝",
    "locked": false,
    "recipe": {
      ...
      "method": "Warm the honey slightly so it dissolves easily — ten seconds in your hands works. Squeeze the lemons into a jug, add the honey and salt, stir well, pour in the water. Taste and adjust. Drink slowly, in a garden, if possible.",
  ...
  },
  {
    ...
    "recipe": {
      ...
      "method": "Put the ginger in a mug. Pour the hot water over it and leave for five minutes — the waiting is part of it. Add the lemon and honey, stir slowly. Hold the mug with both hands. Drink it somewhere quiet.",
