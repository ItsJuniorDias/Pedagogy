...
// história: ASTRONAUT · idioma: hi · modelo: mock · 2026-07-01
...
export const ASTRONAUT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Lesson 1",
    "subtitle": "[hi] What Is Space, Exactly?",
    "emoji": "🌌",
    "locked": false,
    "factFile": {
      "topic": "The Universe",
