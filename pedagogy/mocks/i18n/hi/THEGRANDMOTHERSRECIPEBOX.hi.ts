...
// história: THEGRANDMOTHERSRECIPEBOX · idioma: hi · modelo: mock · 2026-07-01
...
export const THEGRANDMOTHERSRECIPEBOX: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Soup for Homesickness",
    "emoji": "🍲",
    "locked": false,
    "recipe": {
