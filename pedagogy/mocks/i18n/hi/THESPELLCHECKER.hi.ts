...
// história: THESPELLCHECKER · idioma: hi · modelo: mock · 2026-07-01
...
export const THESPELLCHECKER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Red Pen That Wasn't",
    "emoji": "✏️",
    "locked": false,
    "dictionaryEntry": {
      "word": "Orthomancy",
