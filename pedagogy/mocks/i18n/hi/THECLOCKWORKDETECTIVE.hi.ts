...
// história: THECLOCKWORKDETECTIVE · idioma: hi · modelo: mock · 2026-07-01
...
export const THECLOCKWORKDETECTIVE: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Case of the Stolen Afternoon",
    "emoji": "🔍",
    "locked": false,
    "riddle": {
