...
// história: DINOSAURS · idioma: hi · modelo: mock · 2026-07-01
...
export const DINOSAURS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Lesson 1",
    "subtitle": "[hi] The Age of Dinosaurs",
    "emoji": "🦖",
    "locked": false,
    "activityCard": {
