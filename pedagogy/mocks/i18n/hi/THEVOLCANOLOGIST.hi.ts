...
// história: THEVOLCANOLOGIST · idioma: hi · modelo: mock · 2026-07-01
...
export const THEVOLCANOLOGIST: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Mountain That Breathes",
    "emoji": "🌋",
    "locked": false,
    "scienceFact": {
