...
// história: THECLOUDREADER · idioma: hi · modelo: mock · 2026-07-01
...
export const THECLOUDREADER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] Partly Cloudy With a Chance of Everything",
    "emoji": "⛅",
    "locked": false,
    "weatherReport": {
