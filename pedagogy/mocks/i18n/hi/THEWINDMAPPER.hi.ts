...
// história: THEWINDMAPPER · idioma: hi · modelo: mock · 2026-07-01
...
export const THEWINDMAPPER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Invisible Rivers",
    "emoji": "💨",
    "locked": false,
    "weatherReport": {
      "date": "Any windy day",
