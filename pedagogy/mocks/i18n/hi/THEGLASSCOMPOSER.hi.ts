...
// história: THEGLASSCOMPOSER · idioma: hi · modelo: mock · 2026-07-01
...
export const THEGLASSCOMPOSER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] Music in the Broken Things",
    "emoji": "🎼",
    "locked": false,
    "poem": {
