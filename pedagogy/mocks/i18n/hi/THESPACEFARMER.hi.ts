...
// história: THESPACEFARMER · idioma: hi · modelo: mock · 2026-07-01
...
export const THESPACEFARMER: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] Soil at Zero Gravity",
    "emoji": "🌾",
    "locked": false,
    "scienceFact": {
