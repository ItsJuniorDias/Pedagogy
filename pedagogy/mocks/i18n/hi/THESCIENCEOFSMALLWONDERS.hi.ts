...
// história: THESCIENCEOFSMALLWONDERS · idioma: hi · modelo: mock · 2026-07-01
...
export const THESCIENCEOFSMALLWONDERS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] What Rain Smells Like",
    "emoji": "🌧️",
    "locked": false,
    "scienceFact": {
      "title": "Petrichor",
