...
// história: THEARTOFBEING · idioma: hi · modelo: mock · 2026-07-01
...
export const THEARTOFBEING: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Best Wrong Answer",
    "emoji": "🎨",
    "locked": false,
    "scienceFact": {
