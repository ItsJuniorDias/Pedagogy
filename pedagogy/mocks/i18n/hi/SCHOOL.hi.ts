...
// história: SCHOOL · idioma: hi · modelo: mock · 2026-07-01
...
export const SCHOOL: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Lesson 1",
    "subtitle": "[hi] The Morning of Everything",
    "emoji": "🌤️",
    "locked": false,
    "feelingCard": {
      "emoji": "😬",
