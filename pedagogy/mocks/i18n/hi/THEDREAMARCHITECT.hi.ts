...
// história: THEDREAMARCHITECT · idioma: hi · modelo: mock · 2026-07-01
...
export const THEDREAMARCHITECT: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Blueprint in the Dark",
    "emoji": "💭",
    "locked": false,
    "runeSymbol": {
      "symbol": "⌖",
