...
// história: THECOLOURTHIEF · idioma: hi · modelo: mock · 2026-07-01
...
export const THECOLOURTHIEF: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] When Orange Went Missing",
    "emoji": "🎨",
    "locked": false,
    "creatureCard": {
