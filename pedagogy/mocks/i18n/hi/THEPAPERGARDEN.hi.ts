...
// história: THEPAPERGARDEN · idioma: hi · modelo: mock · 2026-07-01
...
export const THEPAPERGARDEN: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] What You Can Make From a Square",
    "emoji": "🌸",
    "locked": false,
    "recipe": {
