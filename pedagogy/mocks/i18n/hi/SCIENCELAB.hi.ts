...
// história: SCIENCELAB · idioma: hi · modelo: mock · 2026-07-01
...
export const SCIENCELAB: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Lesson 1",
    "subtitle": "[hi] Thinking Like a Scientist",
    "emoji": "🔬",
    "locked": false,
    "labNotebook": {
