...
// história: THEINSECTORCHESTRA · idioma: hi · modelo: mock · 2026-07-01
...
export const THEINSECTORCHESTRA: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] First Movement: The Cricket Section",
    "emoji": "🦗",
    "locked": false,
    "verse": {
      "lines": [
