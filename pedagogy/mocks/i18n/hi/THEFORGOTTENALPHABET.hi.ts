...
// história: THEFORGOTTENALPHABET · idioma: hi · modelo: mock · 2026-07-01
...
export const THEFORGOTTENALPHABET: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Letters That Were Left Behind",
    "emoji": "🔤",
    "locked": false,
    "letterFriend": {
      "letter": "Ƿ",
