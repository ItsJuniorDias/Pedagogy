...
// história: THECITYOFCLOCKS · idioma: hi · modelo: mock · 2026-07-01
...
export const THECITYOFCLOCKS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] Where Every Second Is Counted",
    "emoji": "🕰️",
    "locked": false,
    "missionBrief": {
