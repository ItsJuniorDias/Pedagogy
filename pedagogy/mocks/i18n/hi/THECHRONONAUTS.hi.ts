...
// história: THECHRONONAUTS · idioma: hi · modelo: mock · 2026-07-01
...
export const THECHRONONAUTS: LocalizedChapter[] = [
  {
    "id": 1,
    "title": "[hi] Chapter 1",
    "subtitle": "[hi] The Archaeology of Now",
    "emoji": "⏳",
    "locked": false,
    "missionBrief": {
